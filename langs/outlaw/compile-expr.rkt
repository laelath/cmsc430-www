...
;; Lambda GEnv -> Asm
(define (compile-lambda-body l g fvs)
  (match l
    [(Lam f xs e)
    ...
    [(LamCase f cs)
     (seq ; (%%% "lamcase code")
      ...
      (compile-fun-case-clauses cs g fvs))]))

(define (compile-fun-case-clauses cs g fvs)
  (append-map (lambda (c) (compile-lambda-body c g fvs)) cs))
